...
public class PinchRecognizerInspector : GestureRecognizerInspector<PinchRecognizer>
{
    ...
    protected static GUIContent LABEL_MinDistance = new GUIContent("Minimum Distance",
        "Minimum gap required between the two fingers in order to begin the pinch gesture recognition");
