...
public class TapRecognizerInspector : GestureRecognizerInspector<TapRecognizer>
{
    protected static GUIContent LABEL_RequiredTaps = new GUIContent("Required Taps",
        "How many consecutive taps are required to recognize the gesture.");
    ...
    protected static GUIContent LABEL_MaxDuration = new GUIContent("Max Duration",
        "Maximum amount of time the fingers can be held down without failing the gesture.\nSet to 0 for infinite duration.");
    ...
    protected override void OnSettingsUI()
    {
        ...
        Gesture.MaxDelayBetweenTaps =
            EditorGUILayout.FloatField(LABEL_MaxDelayBetweenTaps, Gesture.MaxDelayBetweenTaps);
        EditorGUI.indentLevel--;
        GUI.enabled = true;
