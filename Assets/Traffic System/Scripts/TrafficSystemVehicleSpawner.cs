...
public class TrafficSystemVehicleSpawner : MonoBehaviour
{
    ...
    [Range(0.0f, 1.0f)] public float m_nodeVehicleSpawnChance = 0.0f;
    ...
    public TrafficSystemVehicle SpawnRandomVehicle(bool a_ignoreChangeOfSpawning = false)
    {
        ...
        TrafficSystemVehicle vehicle =
            Instantiate(m_vehiclePrefabs[randIndex], transform.position, transform.rotation) as TrafficSystemVehicle;
