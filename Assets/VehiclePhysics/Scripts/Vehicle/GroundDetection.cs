...
namespace NWH.VehiclePhysics
{
    public class GroundDetection : MonoBehaviour
    {
        ...
        public class GroundEntity
        {
            ...
            /// </summary>
            [Tooltip("Intensity of dust generated by wheel traveling over sand, gravel, etc.")] [Range(0, 50)]
        ...
        /// </summary>
        [Tooltip("Ground entities - each represents a single ground surface.")] [SerializeField]
        ...
        {
            if (wheelController.isGrounded && wheelController.wheelHit != null &&
                wheelController.wheelHit.raycastHit.transform != null)
            {
                ...
                if (activeTerrain)
                {
                    ...
                    if (dominantTerrainIndex != -1)
                    {
                        foreach (GroundEntity groundEntity in groundEntities)
                        {
                            if (groundEntity.terrainTextureIndices.Count > 0 &&
                                groundEntity.terrainTextureIndices.Contains(dominantTerrainIndex))
                            {
                                return groundEntity;
                            }
                        }
