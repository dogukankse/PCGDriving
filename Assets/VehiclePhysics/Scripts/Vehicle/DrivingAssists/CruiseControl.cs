...
namespace NWH.VehiclePhysics
{
    ...
    public class CruiseControl : DrivingAssists.DrivingAid
    {
        ...
        [Tooltip(
            "Should cruise control system use brakes if speed is too high? I set to false cruise control will only use throttle to regulate speed.")]
        public bool useBrakesOnOverspeed = true;

        [Tooltip(
            "How hard should cruise control brake when overspeeding? 1 equals max brake torque set under Brakes dropdown.")]
